...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public abstract class Manipulator : MonoBehaviour
    {
        ...
        {
            Debug.Log("Manipulator - OnStartManipulation");
            // Optional override.
        }
        ...
        {
            Debug.Log("Manipulator - OnEnable");
        ...
        {
            Debug.Log("Manipulator - ConnectToRecognizers");
            ...
            {
                Debug.Log("Manipulator - ConnectToRecognizers 2");
        ...
        private void OnGestureStarted(TapGesture gesture)
        {
            ...
            Debug.Log("Manipulator - OnGestureStarted 2");

            if (CanStartManipulationForGesture(gesture))
            {
                Debug.Log("Manipulator - OnGestureStarted 3");
        ...
        {
            MessageManager.ShowAndroidToastMessage("OnUpdated en Manipulator 1");
            ...
            MessageManager.ShowAndroidToastMessage("OnUpdated en Manipulator");
