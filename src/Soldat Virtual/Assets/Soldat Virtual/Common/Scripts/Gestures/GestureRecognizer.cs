    ...
    public abstract class GestureRecognizer<T> where T : Gesture<T>
    {
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < m_Gestures.Count; i++)
            {
                ...
                Debug.Log("GestureRecognizer - Process Gesture: " + m_Gestures[i].GetType());
        ...
        protected internal void TryCreateOneFingerGestureOnTouchBegan(Func<Touch, T> createGestureFunction)
        {
            ...
            {
                Debug.Log("GestureRecognizer - TryCreateOneFingerGestureOnTouchBegan");
                ...
                {
                    Debug.Log("GestureRecognizer - TryCreateOneFingerGestureOnTouchBegan 222");
